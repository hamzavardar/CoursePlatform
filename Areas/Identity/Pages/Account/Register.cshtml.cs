...
public class RegisterModel : PageModel
{
    ...
    public class InputModel
    {
        ...
        [Required(ErrorMessage = "Lütfen bir hesap türü seçiniz.")]
    ...
    public async Task<IActionResult> OnPostAsync(string? returnUrl = null)
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation("Kullanıcı parolasıyla yeni bir hesap oluşturdu.");

                // Seçilen Rolün Kontrolü ve Atanması
                ...
                {
                    // Varsayılan olarak Student atanır
    ...
    private ApplicationUser CreateUser()
    {
        ...
        catch
        {
            throw new InvalidOperationException($"'{nameof(ApplicationUser)}' örneği oluşturulamadı. " +
                $"'{nameof(ApplicationUser)}' sınıfının parametresiz bir oluşturucuya sahip olduğundan emin olun.");
        }
    }
